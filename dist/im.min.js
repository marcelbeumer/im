...
(function(ns){var VERSION="1.2.x-DEV";var prevNS=ns.im;var im=ns.im=function(selector,context){return new Chain(selector,context);};im.version=VERSION;im.noConflict=function(){ns.im=prevNS;return im;};im.browser=(function(){try{var userAgent=navigator.userAgent.toLowerCase();}catch(e){var userAgent='';}
