...
(function(window,document,environment){var version="1.2.2",prev_im=environment?environment.prev_im:window.im,callee=arguments.callee,constructors=environment?environment.constructors:{},im;im=function(selector,context){return new Chain(selector,context);};im.version=version;if(environment){environment.im=im;}else{window.im=im;}
